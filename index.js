...
fs.readdir("./commands/moderation/", (err, files) => {
  ...
  files.forEach(file => {
    ...
    clinet.moderation.set(commandName, props);
  });
});
...
fs.readdir("./commands/interaction/", (err, files) => {
  ...
  files.forEach(file => {
    ...
    let commandName = file.split(".")[0];
    clinet.interaction.set(commandName, props);
  });
});
...
fs.readdir("./commands/utils/", (err, files) => {
  ...
  files.forEach(file => {
    ...
    let commandName = file.split(".")[0];
    clinet.utils.set(commandName, props);
  });
});
...
fs.readdir("./commands/configuration/", (err, files) => {
  ...
  files.forEach(file => {
    ...
    let commandName = file.split(".")[0];
    clinet.configuration.set(commandName, props);
  });
});
...
fs.readdir("./commands/administrator/", (err, files) => {
  ...
  files.forEach(file => {
    ...
    let commandName = file.split(".")[0];
    clinet.administrator.set(commandName, props);
  });
});
